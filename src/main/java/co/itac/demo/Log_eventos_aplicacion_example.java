...
@Slf4j
public class Log_eventos_aplicacion_example {
    ...
    /**
     * Este metodo permite generar la prueba de registrar en el log los datos del contexto de aplicación más los datos
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            log.error("Se generó error '" + e.getMessage() + "' Prueba alcance: Aplicación", e);
        }
    }
    ...
    public static void imprimirLog(DatosParaPruebas datos) {
        ...
        for (int i = 0; i < datos.getNombresGenerados().length; i++) {
            ...
            log.info("Demostración envío de tramas en una transacción bancaria: {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}.",
                    ...
                    kv("Cuenta", cuenta),
                    kv("Trama", trama),
                    kv("Transacción", "AP".concat(String.valueOf(idTransaccion).concat(datos.getTiposTransaccionesGenerados()[i]))),
